	...
	var whatsappHTML = `<!--Whatsapp-->
		<object class="sharerbox-icon-fig" id="ws-fig">
			<a class="sharerbox-socialmedia-link" id="ws-link" target="_blank">
				<svg class="sharerbox-icon" id="ws-icon" width="1225px" height="1225px" version="1.1" viewBox="-2.73 0 1225 1225">
	...
	var linkedinHTML = `<!--LinkedIn-->
		<object class="sharerbox-icon-fig" id="linkedin-fig">
			<a class="sharerbox-socialmedia-link" id="linkedin-link" target="_blank">
				<svg class="sharerbox-icon" id="linkedin-icon" enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512" xml:space="preserve">
	...
	var pinterestHTML = `<!--Pinterest-->
		<object class="sharerbox-icon-fig" id="pinterest-fig">
			<a class="sharerbox-socialmedia-link" id="pinterest-link" target="_blank">
				<svg class="sharerbox-icon" id="pinterest-icon" width="75" height="75" version="1.1" viewBox="0 0 75 75">
...
<section id="sharerbox-section">
	<div id="sharerbox-copy-url-wrap">
		...
		<!--Send Email Button-->
			<object class="extra-buttons-fig" id="send-email-button-fig">
				<a class="sharerbox-socialmedia-link" id="send-email-link" title="Send Email">
					<svg id="send-email-button" class="extra-buttons" enable-background="new 0 0 493.497 493.497" version="1.1" viewBox="0 0 493.5 493.5" xml:space="preserve">
						<rect id="sb-email-envelope-bg" x="90.963" y="146.38" width="314.71" height="197.09" fill="white" style="paint-order:fill markers stroke"/>
		...
		<object class="extra-buttons-fig" id="copy-link-fig" title="Copy Link">
			<svg class="extra-buttons" id="copy-link-icon" width="1306.7" height="1306.7" version="1.1" viewBox="0 0 1306.7 1306.7">
	...
	<div id="sharerbox-share-icon-wrap">
		...
		<object id="sharerbox-share-icon-fig" title="Share!">
			<svg class="sharerbox-icon" id="sharerbox-share-icon" enable-background="new 0 0 57.884 57.884" viewBox="0 0 57.884 57.884" xml:space="preserve">
...
// Function for Sharerbox's preferences customization;
	...
	function sharerSetup(behavior = 'popup', position = 'right', color = 'black', visibility = 'hidden', shareDescription = ''){
		...
		if(emailButtonLink){
			emailButtonLink.href = sendEmailURL; // Email
		}
		...
		if(position === 'right'){
			...
			for(i = 0; i <= (socialIconsCollection.length - 2); i++){
